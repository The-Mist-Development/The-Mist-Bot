...
class Player {
    ...
    constructor(client, options = {}) {
         ...
         * @type {PlayerOptions}
         */
        this.options = {...PlayerOptions, ...options};
        /**
         * ytsr
         * @type {ytsr}
         */
    ...
    async play(voiceChannel, songName, options = {}, requestedBy) {
        ...
        if (!voiceChannel) return new MusicPlayerError('VoiceChannelTypeInvalid', 'song');
    ...
    async playlist(guildID, playlistLink, voiceChannel, maxSongs, requestedBy) {
        ...
        if (!queue) if (voiceChannel.type !== 'voice' || !voiceChannel.type) return new MusicPlayerError('VoiceChannelTypeInvalid', 'song', 'playlist');
